...
import {  faChartPie, faCog, faHandHoldingUsd, faSignOutAlt, faTimes, faPlane } from "@fortawesome/free-solid-svg-icons";
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              ...
              <NavItem title="User Trips" link={Routes.UserTrips.path} icon={faPlane} />

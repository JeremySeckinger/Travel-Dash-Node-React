                        ...
                        <Col xs={12} className="d-flex align-items-center justify-content-center">
                            ...
                            <Form className="mt-4" onSubmit={handleSubmit}>
                                <Form.Group id="firstName" className="mb-4">
                                    ...
                                    <Form.Control name="firstName" onChange={handleChange} autoFocus required type="firstName" placeholder="first name" />
                                    </InputGroup>
                                </Form.Group>
                                <Form.Group id="lastName" className="mb-4">
                                    ...
                                    <Form.Control name="lastName" onChange={handleChange} autoFocus required type="lastName" placeholder="last name" />
                                    </InputGroup>
                                </Form.Group>
                                ...
                                <Form.Group id="confirmPassword" className="mb-4">
                                    ...
                                    <InputGroup>
                                        ...
                                        <Form.Control name="confirmPassword" onChange={handleChange} required type="password" placeholder="Confirm Password" />
                                    </InputGroup>
                                </Form.Group>
